# Kodefiz (Vite) + Next.js Email API
...
$env:SMTP_HOST="mail.Kodefiz.com"
$env:SMTP_PORT="465"
$env:SMTP_USER="info@Kodefiz.com"
$env:SMTP_PASS="(c3OY=!r4-+C,CmT"
$env:SMTP_FROM="info@Kodefiz.com"     # optional
$env:SMTP_TO="info@Kodefiz.com"         # optional (defaults to maliksuhaib543@gmail.com)

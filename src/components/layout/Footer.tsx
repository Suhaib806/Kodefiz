...
const socialItems = [
  { label: "Facebook", href: "https://www.facebook.com/Kodefiz?mibextid=ZbWKwL", abbr: "f" },
  { label: "Instagram", href: "https://www.instagram.com/Kodefiz", abbr: "ig" },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/Kodefiz/", abbr: "in" },
    ...
    <footer className="bg-navy-950 text-white">
      <div className="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-12 sm:py-14 md:py-16">
          ...
          <div className="flex items-center gap-2 mb-6">
              {socialItems.map((item) => (
                <a
                  ...
                  className="h-7 w-7 rounded-full border border-white/25 text-[11px] text-white/85 flex items-center justify-center hover:border-brand hover:text-brand transition-colors duration-300"
                >
                  {item.abbr}
                </a>
              ))}
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-[13px] text-white/50">
          <p>
            © {new Date().getFullYear()} Kodefiz. All rights reserved. Powered by Kodefiz.
          </p>
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 uppercase">
            <a href="/terms-condition" className="hover:text-brand transition-colors duration-300">
              Terms of use
            </a>
            <a href="/privacy-policy" className="hover:text-brand transition-colors duration-300">
              Privacy policy
            </a>
          </div>
        </div>

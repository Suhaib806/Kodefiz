        ...
        <div className="grid lg:grid-cols-2 gap-20 items-end mb-20">
          ...
          <div>
            ...
            <h2 className="text-5xl lg:text-7xl font-bold leading-[0.95] tracking-tight text-[#132F48]">
              ...
              <br />
              behind
              <span className="text-[#F76F01]"> Kodefiz.</span>
            </h2>
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 leading-8">
              Behind every successful client partnership is a leadership team
              focused on quality, innovation, and long-term growth.
              Together, we lead a network of developers, designers,
              marketers, accountants, AI specialists, and operations experts.
            </p>
          ...
          {leadership.map((person) => (
            ...
            >
              ...
              <div className="mt-6">
                ...
                <h3 className="text-2xl font-semibold text-[#132F48]">

                  {person.name}

                </h3>

                <p className="mt-2 text-[#F76F01]">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-y-8">
              ...
              <div>
                ...
                <p className="text-gray-500 mt-2">
                  UI/UX • Branding • Motion Graphics
                </p>
              </div>

        ...
        <div className="w-full px-4 sm:px-6">
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className="text-xs tracking-[0.2em] font-medium text-navy-400 flex items-center gap-3">
                <span className="inline-flex h-[10px] w-[10px] bg-brand rounded-full" />
                WHY&nbsp;US
              </div>
            </div>
            <h2 className="text-[34px] leading-[1.12] font-display font-bold tracking-tight text-navy-950 mb-3">
              Why partner{" "}
          ...
          <div className="mx-auto w-[260px] h-[260px] rounded-full overflow-hidden flex items-center justify-center bg-radial-soft mb-8">
            <img
              src={phoneMockup}
              alt="Kodefiz product showcase"
          ...
          <div className="space-y-3">
            {whyUsSteps.map((step) => (
              <div
                key={step.title}
                className="rounded-xl border border-navy-200 bg-white px-4 py-3"
              >
                <h3 className="text-[15px] font-medium text-navy-950">
                  {step.title} <span className="font-bold">{step.titleBold}</span>
                </h3>
                <p className="mt-1 text-[13px] leading-[1.5] text-navy-500">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <div ref={triggerRef}>
      ...
      >
        ...
        <div className="text-center mb-8 md:mb-12 px-4 z-10">
          ...
          <h2 className="text-[34px] sm:text-[42px] lg:text-[52px] leading-[1.12] font-display font-bold tracking-tight text-navy-950 mb-4">
            Why partner{" "}
            <span className="bg-clip-text text-transparent text-gradient-heading">
              with us
            </span>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: circleSize,
              background:
              background: "radial-gradient(circle, hsl(var(--orange-100)) 0%, hsl(var(--navy-50)) 40%, hsl(0 0% 100%) 100%)",
            }}
          >
                    ...
                    return (
                      <span className={`inline-flex items-start gap-2 ${isRight ? "flex-row-reverse" : ""}`}>
                        <span
                          ...
                          style={{
                            background: isActive ? ACCENT : "hsl(var(--navy-300))",
                          }}
                        />
                        <span
                          style={{

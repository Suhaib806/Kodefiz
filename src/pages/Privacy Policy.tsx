...
const PrivacyPolicy = () => {
  return (
    <main className="min-h-screen bg-white text-navy-950">
      {/* Hero */}
      <section className="w-full px-4 sm:px-6 md:px-12 lg:px-20 pt-24 pb-16 border-b border-white/10 bg-navy-950">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center gap-3 flex-shrink-0">
                  <span className="text-brand/40 text-[12px] font-mono tabular-nums">
                ...
                <div className="flex-1 pt-1">
                  <h2 className="text-[18px] sm:text-[20px] font-medium text-navy-950 leading-snug mb-5">
                    {section.title}
                  </h2>
                    ...
                    <ul className="space-y-4">
                      {section.items.map((item, i) => (
                        <li key={i} className="flex items-start gap-3">
                          <span className="mt-[6px] flex-shrink-0 w-5 h-5 rounded-full bg-navy-950/10 border border-navy-300 flex items-center justify-center">
                            <span className="text-brand text-[10px] font-mono font-medium">
                              {i + 1}
                            </span>
                          </span>

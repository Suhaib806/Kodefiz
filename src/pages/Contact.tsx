...
const faqs = [
  { q: "What services does Kodefiz offer?", a: "We specialize in innovative software solutions, web development, and digital strategy consulting. For a full list of our services, please visit our Services page." },
  { q: "How can I contact Kodefiz?", a: "You can reach us through our Contact page, where you'll find our email address, phone number, and contact form." },
  { q: "What industries do you serve?", a: "We work with a diverse range of industries, including technology, healthcare, finance, and more. Our team is equipped to handle various sector-specific needs." },
  { q: "How do I request a quote for a project?", a: "To request a quote, please fill out the form on our Quote Request page, providing as much detail as possible about your project." },
...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    if (!existingScript) {
      ...
      // Re-init on SPA route changes where script already exists.
      window.setTimeout(initCalendly, 0);
    }

    // Trigger again after animation/layout settles.
    const timer = window.setTimeout(initCalendly, 350);
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 relative z-[1]">
            <div className="lg:col-span-3">
              <div className="rounded-[28px] border border-navy-200 bg-white/80 backdrop-blur shadow-card px-6 sm:px-8 py-8 sm:py-10">
                <Reveal>
            ...
            <div className="lg:col-span-2">
              <Reveal direction="right">
                <div className="bg-white/70 rounded-[28px] p-8 border border-navy-200 shadow-card mb-8">
                  <div className="flex items-start justify-between gap-4 mb-6">
                    <div>
                      <p className="text-xs tracking-[0.2em] font-medium text-navy-400 uppercase flex items-center gap-3">
                        <span className="inline-flex h-[10px] w-[10px] rounded-full bg-brand" />
                        Authority
                      </p>
                      <h3 className="font-display font-semibold text-navy-950 text-[26px] mt-2">
                    ...
                    <div className="hidden sm:flex h-12 w-12 rounded-2xl bg-navy-100 items-center justify-center border border-navy-200">
                  ...
                  <div className="space-y-5">
                    {contactInfo.map((info) => (
                      <div key={info.label} className="flex items-start gap-4">
                        <div className="w-11 h-11 rounded-2xl bg-navy-100 flex items-center justify-center flex-shrink-0 border border-navy-200">
                          <info.icon className="w-5 h-5 text-brand" />
                        </div>
                        <div>
                          <p className="text-xs text-navy-400">{info.label}</p>
                          <p className="text-sm font-medium text-navy-950">{info.value}</p>
                        </div>
                      </div>
                    ))}
                  </div>

                  <div className="mt-7 pt-6 border-t border-navy-200 grid grid-cols-1 gap-4">
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 w-9 h-9 rounded-2xl bg-navy-100 border border-navy-200 flex items-center justify-center">
                        <ShieldCheck className="w-4 h-4 text-brand" />
                      </div>
                      <div>
                        <p className="text-sm font-medium text-navy-950">NDA-friendly</p>
                        <p className="text-sm text-navy-500 leading-relaxed">We can sign NDAs before sharing sensitive details.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-navy-950">Clear milestones</p>
                        <p className="text-sm text-navy-500 leading-relaxed">Weekly updates, transparent scope, and measurable progress.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-navy-950">Response in 24h</p>
                        <p className="text-sm text-navy-500 leading-relaxed">On business days, we typically reply within 24 hours.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Reveal direction="right" delay={0.1}>
                <div className="bg-navy-100 rounded-[24px] p-6 border border-navy-200">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-white/70 border border-navy-200 flex items-center justify-center">
                      <Clock className="w-5 h-5 text-brand" />
                    </div>
                    <div>
                      <p className="text-sm text-navy-950 font-medium mb-1">Kickoff starts soon</p>
